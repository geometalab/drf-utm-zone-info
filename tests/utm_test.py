...
from utm_zone_info.coordinate_reference_system import UTMZone, wrap_longitude_degrees, utm_zones_for_representing, \
...
@pytest.fixture(
    params=UTM_ZONE_NUMBERS if pytest.config.getoption("--all-utm-zones") else random.sample(UTM_ZONE_NUMBERS, 3),
)
